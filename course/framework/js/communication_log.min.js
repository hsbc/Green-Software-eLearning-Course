...
function updateLog(t){$(".logtext").html(t)}$(document).ready(function(){window.onunload=function(){window.opener.closeCommunicationWin()},updateLog(window.opener.storageComms.getLogString()),$(".filter").on("click",function(){$(this).toggleClass("active"),$(this).hasClass("active")?$(".logtext").addClass("show-"+$(this).data("item")):$(".logtext").removeClass("show-"+$(this).data("item"))})});
//# sourceMappingURL=communication_log.min.js.map
