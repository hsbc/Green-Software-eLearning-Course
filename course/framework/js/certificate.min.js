...
$(document).ready(function(){var t=window.opener.getCertificateData();$("body").addClass("lang-"+t.language.code+" "+t.language.direction),$(".CR-title").html(t.text.title[0].Text),$(".CR-SName").html(t.studentName),$(".CR-cmp").html(t.text.text[0].Text),$(".CR-courseName").html(t.courseName),$(".CR-Date").html(t.text.date[0].Text.split("{date}").join(t.completionDate)),$(".CR-ID").html(t.text.courseid[0].Text.split("{courseid}").join(t.courseID)),$(".certificate").show();setTimeout(function(){window.print()},1e3)});
//# sourceMappingURL=certificate.min.js.map
